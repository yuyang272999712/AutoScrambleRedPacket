package com.yuyang.autoscrambleredpacket.keepAlive.receiver;
...
public class ScreenReceiverUtil {
    ...
    public void setScreenReceiverListener(ScreenStateListener stateListener){
        ...
        filter.addAction(Settings.System.SCREEN_BRIGHTNESS);
    ...
    public class ScreenBroadcastReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            LogUtils.e("KeepAppAlive","ScreenLockReceiver-->监听到系统广播："+action);
